...
require (
	...
	github.com/pb33f/libopenapi v0.38.6 // indirect
...
replace github.com/prometheus/prometheus => github.com/grafana/mimir-prometheus v1.8.2-0.20260710235338-c2914fbf45a2
